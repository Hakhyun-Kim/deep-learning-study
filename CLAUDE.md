...
- exp04_aug_epochs20: exp03 + 에폭 20, best 75.80% (ep12, 이후 과적합).
  **+TTA(5-crop 평균) = 77.77%** — 현재 최고 기록. 위치 민감도 실측: 중앙이
  모서리보다 +7.1%p (photographer's bias). 상세는 notes/ch3/notes.md
- 다음 갈림길: TTA 확정 vs person-crop 등 추가 실험 (ch3 마무리 단계)
