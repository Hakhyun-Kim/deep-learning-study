...
| 챕터 | 주제 | 상태 |
|---|---|---|
| [ch1](ch1/README.md) | 전이학습 베이스라인 — 딥러닝 기본 개념 + exp01 (69.4%) | 완료 (q02·q03 내 답 채우기 남음) |
| [ch2](ch2/README.md) | 전체 파인튜닝 — exp02, 목표 80% 근접 | 진행 중 |
...
| # | 질문 | 상태 | 관련 |
|---|------|------|------|
| [q03](ch1/q03-full-finetune-low-lr.md) | 전체 파인튜닝은 왜 학습률을 10배 낮추나? | 🤔 ch1에서 이월 | exp02 |
| [q07](ch2/q07-why-slower-epochs.md) | 학습 파라미터가 546배인데 에폭 시간도 546배 걸릴까? | 🤔 스스로 생각해보기 | exp02 실측 |
