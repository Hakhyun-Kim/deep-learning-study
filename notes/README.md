...
| [ch3](ch3/README.md) | 분석과 개선 — 진단(지름길·중앙 prior) → 증강·TTA·person-crop → 두-시야 앙상블 🎉 **80.71%** | 완료 (**목표 80% 달성**) |
| [ch4](ch4/README.md) | 마무리 — 최종 재진단, 한계의 정직한 기록(모델 카드), 회고 | 문서 완료, 학습자 회고 남음 |
