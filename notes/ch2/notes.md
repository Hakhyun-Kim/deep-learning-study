...
- 에폭당 시간: exp01은 ~18초였다. exp02는 ___초일 것 같다 (이유: ___)
  → [q07](q07-why-slower-epochs.md)
- 에폭 1의 test_acc: exp01은 54.6%였다. exp02는 더 높을까 낮을까? ___
  (힌트: 백본이 움직이기 시작하면 초반엔 오히려 흔들릴 수도)
- 최종 test_acc: ___% (exp01 69.4% 대비)
- 과적합 신호(test_loss 상승)가 나타날까? 몇 에폭쯤? ___
