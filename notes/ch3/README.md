...
- [x] exp05 person-crop: 단독 70.79% (문맥 손실) — 그러나 **두-시야 앙상블 재료**
- [x] 🎉 **최종 80.71%** = 사람시야(exp05) 0.3 + 전체시야(exp04) TTA 0.7 —
      **목표 80% 달성** ([notes.md exp05 결과](notes.md#exp05-결과-2026-07-15-실측-person-crop--실패가-아니라-재료였다))
- [ ] ch4: 최종 정리 (모델 선택 근거, 한계 기록 — 남은 지름길·미세분류·bbox 가정)
